...
app.controller('checkDetail_controller', ['$scope', '$http', '$modal', '$location', function ($scope, $http, $modal, $location) {
    ...
    async function getRegularData() {
        let getFunc = '/Testing/select_Statistics_manage?uid=' + $scope.app.globalInfo.userid+'&power='+JSON.parse(sessionStorage.getItem('msg')).usertype;
    ...
    $scope.loadBtn = async function () {
        let getLoad = '/Testing/select_Statistics_load?uid=' + $scope.app.globalInfo.userid;
